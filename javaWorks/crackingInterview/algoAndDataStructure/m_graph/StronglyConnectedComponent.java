 ...
 * @author Tushar Roy
 *
 *         Given a directed graph, find all strongly connected components in
 *         this graph. We are going to use Kosaraju's algorithm to find strongly
 *         connected component.
 *
 *         Algorithm Create a order of vertices by finish time in decreasing
 *         order. Reverse the graph Do a DFS on reverse graph by finish time of
 *         vertex and created strongly connected components.
 *
