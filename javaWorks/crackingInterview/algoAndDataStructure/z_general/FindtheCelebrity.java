public class FindtheCelebrity {
    ...
    public int findCelebrity(int n) {
        ...
        for(int i = 1; i < n; i++){
            // Here we are filtering two people
            // one: if possibleCelebrity know i, ignore possibleCelebrity
            // person who know other not a celeb, 
            // by reassigning possibleCelebrity to i, Thinking i may be a celebrity
            
            // two: if possibleCelebrity does not know i
            // Then i cannot be a celeb, since he is known to everyone
        ...
        // At this point possibleCelebrity MAY be a celeb, lets verify if he known 
        // to eveyone. Even if one person dosent know him, return -1
        
        for(int i = 0; i < n; i ++){
            if(i != possibleCelebrity && (knows(i,possibleCelebrity) == false
                                      || knows(possibleCelebrity,i) == true)){
                return -1;
            }
        }
