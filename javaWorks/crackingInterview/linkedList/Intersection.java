public class Intersection {
    ...
    /**
     * 1. Run through each linked list to get the lengths and the tails. 2. Compare
     * the tails. If they are different (by reference, not by value), return
     * immediately. There is no intersection. 3. Set two pointers to the start of
     * each linked list. 4. On the longer linked list, advance its pointer by the
     * difference in lengths. 5. Now, traverse on each linked list until the
